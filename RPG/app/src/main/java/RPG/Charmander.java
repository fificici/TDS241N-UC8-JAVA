...
public class Charmander extends Personagem {
    ...
    public Charmander () {
        super("Charmander", 15, 0, 30, 10, 12);
    }
        ...
        System.out.println(this.nome + " usou Scratch em  " + oponente.pokemon + " e causou " + this.ataqueExtra + " de dano! Agora voce tem " + this.mana + " de mana!!!");
    }
